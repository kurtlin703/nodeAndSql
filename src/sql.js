...
class Visitors {
    constructor() {
     ...
     createTable() {
        ...
        this.myParams=[]
        this.successMessage = "Table was created";
        this.errorMessage = "couldnt created table";
        await this.myTryCatch();

    }

     addNewVisitor(fullname, visitorsage, dateofvisit, timeofvisit, assistedby, comments) {
        ...
        this.successMessage="new visitor was added"
        this.errorMessage= "new visitor was not added"
    ...
    deleteVisitor(visitorid) {
     ...
     updateVisitorInfo(visitorid, fullname, visitorsage, dateofvisit, timeofvisit, assistedby, comments) {
        ...
        this.errorMessage = "visitor was not updated";
        this.successMessage = "visitor was updated";
        let results = await this.myTryCatch();
        return results.rows
    }
